...
def initData():
    ...
    getDataSet('demo_r_d2jan','time=2019&precision=1&sex=T&unit=NR&age=TOTAL','population2019') # NUTS1 NUTS2
    ...
    getDataSet('nama_10r_3gdp','unit=EUR_HAB_EU&precision=1&time=2017','gdpPps2017_nuts3') 
